        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPurchase = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductVariantId = table.Column<string>(type: "text", nullable: false),
                    AttributeValueId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantAttributeValues", x => new { x.ProductVariantId, x.AttributeValueId });
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributeValues_AttributeValues_AttributeValu~",
